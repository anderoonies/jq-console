...
(function() {
  ...
  module.exports = {
    jqconsole: function(container, header, prompt_main, prompt_continue, disable_auto_focus) {
      return new JQConsole(container, header, prompt_main, prompt_continue, disable_auto_focus);
    }
  };
